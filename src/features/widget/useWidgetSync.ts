...
import { darkPalette, fadedShiftPair, lightPalette } from '@/theme';
 ...
 */
const colorsOf: WidgetColorLookup = (token) => ({
  light: pairOf(lightPalette, token),
  dark: pairOf(darkPalette, token),
});
...
export function useWidgetSync(): void {
  ...
  }, [track, shiftTypes, trackCount, appearance, holidays, foregroundAt]);
}
